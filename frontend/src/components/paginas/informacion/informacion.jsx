    ...
    useEffect(() => {
        const fetchData = async () => {
            try{
                ...
                const respuesta2 = await Axios.get(`http://localhost:4000/familia/${respuesta1.data.id_familia}`);
                setFamilia(respuesta2.data);

                const respuesta3 = await Axios.get(`http://localhost:4000/colector/${respuesta1.data.id_colector}`);
                setColector(respuesta3.data);

                const respuesta4 = await Axios.get(`http://localhost:4000/localidad/${respuesta1.data.id_localidad}`);
                setLocalidad(respuesta4.data);

                const respuesta5 = await Axios.get(`http://localhost:4000/habitat/${respuesta1.data.id_habitat}`);
